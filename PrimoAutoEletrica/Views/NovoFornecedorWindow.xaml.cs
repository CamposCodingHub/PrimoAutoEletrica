...
namespace PrimoAutoEletrica.Views
{
    public partial class NovoFornecedorWindow : Window
    {
        ...
        {
            if (!ValidarCampos(out var pedidoMinimo, out var nota, out var prazoMedioEntrega))
            {
                return;
            }
        ...
        private bool ValidarCampos(out decimal pedidoMinimo, out int nota, out int prazoMedioEntrega)
        {
            pedidoMinimo = 0;
            nota = 0;
            prazoMedioEntrega = 0;
            ...
            var erroCnpj = CadastroValidationHelper.ValidarCnpj(CNPJTextBox.Text, obrigatorio: false);
