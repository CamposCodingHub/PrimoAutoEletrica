    ...
    public class VendaService
    {
        ...
        public void RegistrarVenda(Venda venda, bool atualizarEstoque = true)
        {
            ...
            try
            {
                ...
                insertVenda.Parameters.AddWithValue("@QuantidadeItens", itensVenda.Sum(item => item.Quantidade));
                ...
                {
                    InserirItemVenda(connection, transaction, venda.Id, item);
        ...
        public Venda? ObterVendaPorId(Guid vendaId)
        {
            ...
            return ObterVendaInterna(connection, transaction: null, vendaId);
        }
