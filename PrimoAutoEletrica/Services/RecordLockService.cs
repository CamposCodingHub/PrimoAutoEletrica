        ...
        public LockResult TryLock(string entityType, string entityId, string? entityDescription = null, int timeoutMinutes = DefaultLockTimeoutMinutes)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    var lockedAt = reader.IsDBNull(5) ? DateTime.MinValue : DateTime.Parse(reader.GetString(5));
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    return new LockInfo
                    {
                        ...
                        SessionId = reader.IsDBNull(6) ? Guid.Empty : Guid.Parse(reader.GetString(6)),
                        MachineName = reader.IsDBNull(7) ? string.Empty : reader.GetString(7),
                        LockedAt = reader.IsDBNull(8) ? DateTime.MinValue : DateTime.Parse(reader.GetString(8)),
                        ExpiresAt = reader.IsDBNull(9) ? DateTime.MinValue : DateTime.Parse(reader.GetString(9)),
                        LastRenewedAt = reader.IsDBNull(10) ? DateTime.MinValue : DateTime.Parse(reader.GetString(10)),
