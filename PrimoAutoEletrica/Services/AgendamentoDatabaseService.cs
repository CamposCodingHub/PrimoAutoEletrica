...
namespace PrimoAutoEletrica.Services
{
    public class AgendamentoDatabaseService
    {
        ...
        private static List<AgendamentoProduto> ObterProdutosDoAgendamento(SqliteConnection connection, Guid agendamentoId)
        {
            ...
            while (reader.Read())
            {
                produtos.Add(new AgendamentoProduto
                {
                    ...
                    PrecoTotal = Convert.ToDecimal(reader.GetDouble(6)),
        ...
        private static List<AgendamentoServico> ObterServicosDoAgendamento(SqliteConnection connection, Guid agendamentoId)
        {
            ...
            while (reader.Read())
            {
                servicos.Add(new AgendamentoServico
                {
                    ...
                    Valor = Convert.ToDecimal(reader.GetDouble(3)),
        ...
        public List<Agendamento> ObterAgendamentosPorData(DateTime data)
        {
            ...
            command.CommandText = @"
                SELECT * FROM Agendamentos
                WHERE date(DataAgendamento) = @data
        ...
        private void CarregarDadosRelacionados(SqliteConnection connection, Agendamento agendamento)
        {
        ...
        private static List<AgendamentoTimeline> ObterTimelineDoAgendamento(SqliteConnection connection, Guid agendamentoId)
        {
        ...
        private static bool TabelaRelacionadaExiste(SqliteConnection connection, string tableName)
        {
            using var command = connection.CreateCommand();
            command.CommandText = @"
                SELECT 1
        ...
        private static Agendamento LerAgendamento(SqliteDataReader reader)
        {
            return new Agendamento
            {
                ...
                ClienteTotalGasto = (decimal)reader.GetDouble(20),
                ...
                ValorEstimado = (decimal)reader.GetDouble(40),
                ValorReal = (decimal)reader.GetDouble(41),
                ValorPago = (decimal)reader.GetDouble(42),
                ...
                ValorProdutos = (decimal)reader.GetDouble(52),
                ValorServicos = (decimal)reader.GetDouble(53),
