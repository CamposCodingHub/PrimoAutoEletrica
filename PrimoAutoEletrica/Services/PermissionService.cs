    ...
    public class PermissionService
    {
        ...
        private HashSet<string> ObterModulosPermitidosFallback()
        {
            return NormalizarPerfil(_funcionarioLogado.PerfilAcesso) switch
            {
                ...
                {
                    "Dashboard", "Clientes", "Veiculos", "Orcamentos", "OrdensServico",
                ...
                {
                    "Dashboard", "Veiculos", "OrdensServico", "Agendamentos"
                },
                "VENDEDOR" => new HashSet<string>(StringComparer.OrdinalIgnoreCase)
                {
                    "Dashboard", "Clientes", "Veiculos", "Orcamentos", "OrdensServico", "CatalogoPecas", "Agendamentos"
                },
