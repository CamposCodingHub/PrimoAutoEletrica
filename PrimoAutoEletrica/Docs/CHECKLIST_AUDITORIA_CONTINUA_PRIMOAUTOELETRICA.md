...
Atualizado em: 05/06/2026 07:34
...
- `[x] dotnet build da solucao completa`: executado em 05/06/2026 07:32, incluindo aplicativo, `LocalSyncSimulator`, `DbConfigurator` e testes; 0 avisos, 0 erros.
- `[x] Testes xUnit`: `dotnet test .\Tests\PrimoAutoEletrica.Tests\PrimoAutoEletrica.Tests.csproj --no-build`, 2/2 aprovados em 05/06/2026 07:23.
...
- `[~] Status QA manual`: 62 itens rastreados; 13 aprovados por evidencia automatizada/decisao tecnica implementada, 0 reprovados, 0 ressalvas e 49 pendentes de execucao manual. Validador: `../Scripts/Get-QaManualStatus.ps1`; evidencia gerada: `../Artifacts/QA_MANUAL_STATUS_20260604.md`.
...
- `[x] Grades de Relatorios somente leitura`: corrigida excecao de binding TwoWay em `DadoConciliacaoFinanceira.Status`; bloco filtrado `Relatorios` aprovado em 5/5, evidencia `bin/Debug/net9.0-windows/Logs/smoke-tests/ui-smoke-2026-06-05-07-17-02.txt`.
...
| 15 - Relatorios | [x] Concluido operacional | Botoes/visual foram padronizados; relatorios principais existem; Curva ABC, ranking de produtos parados, margem por produto, vendas por hora/dia, inadimplencia detalhada, DRE operacional e conciliacao financeira foram adicionados; as sete grades de consulta agora sao somente leitura, evitando binding TwoWay em propriedades calculadas; bloco filtrado `Relatorios` aprovado em 5/5, incluindo exportacoes e regressao `GradesSomenteLeitura`. | QA manual de Relatorios/exportacoes com dados reais e conferencia do arquivo gerado. |
...
| 21 - Testes obrigatorios | [~] Automatizado completo / manual pendente | Build da solucao completa em 0 avisos/0 erros e testes xUnit 2/2; ultimo smoke UI completo 154/154, evidencia `ui-smoke-2026-06-04-10-19-37.txt`; smokes filtrados de Importar NF-e 3/3, Fornecedores 4/4, Relatorios 5/5, snapshot NF-e, pre-check sem modais e textos do comprovante aprovados; roteiro QA possui 62 itens, sendo 13 aprovados por evidencia automatizada/decisao tecnica e 49 pendentes de campo. | Executar os 49 itens manuais pendentes com app aberto, dados reais e impressora fisica. |
...
1. Executar os 49 itens pendentes de `Docs/ROTEIRO_QA_MANUAL_FINAL_PRIMOAUTOELETRICA.md` com o app aberto: Clientes, Veiculos, OS, tema claro/escuro, Estoque, Relatorios, PDV, Importar NF-e com XML de producao, Fornecedores com NF-e real, Funcionarios/perfis e impressora fisica.
