...
namespace PrimoAutoEletrica.Repositories
{
    public sealed class ProdutoRepository : IProdutoRepository
    {
        ...
        public ProdutoRepository(Func<DbConnection> connectionFactory, LoggerService logger)
        {
        ...
        public Produto? ObterPorId(Guid id)
        {
            ...
            command.CommandText = $@"
                {selectFirst} {ProdutoColumns}
                FROM Produtos
                WHERE Id = @Id
                {limitOne};";
            AddGuidParameter(command, connection, "@Id", id);
        ...
        public void BaixarProdutosDoEstoquePorAgendamento(IEnumerable<AgendamentoProduto> produtos, Guid agendamentoId)
        {
            ...
            try
            {
                foreach (var produto in produtosValidos)
                {
                    ...
                    AddGuidParameter(updateCommand, connection, "@Id", produto.ProdutoId);
            ...
            AgendamentoProduto produto)
        {
            ...
            AddGuidParameter(command, connection, "@Id", produto.ProdutoId);
        ...
        private static Produto MaterializarProduto(DbDataReader reader)
        {
            return new Produto
            {
        ...
        private void ValidarProdutoParaPersistencia(DbConnection connection, Produto produto, Produto? anterior)
        {
        ...
        private static void ResolverFornecedorPrincipal(DbConnection connection, Produto produto)
        {
        ...
        private void ValidarDuplicidade(DbConnection connection, Produto produto)
        {
        ...
        private static void AddProdutoParameters(DbCommand command, Produto produto)
        {
