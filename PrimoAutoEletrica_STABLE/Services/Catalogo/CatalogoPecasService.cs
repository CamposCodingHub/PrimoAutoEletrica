...
namespace PrimoAutoEletrica.Services.Catalogo
{
    public sealed class CatalogoPecasService
    {
        ...
        private List<CatalogoPeca> MaterializarLista(DbCommand command)
        {
        ...
        private static CatalogoPeca Materializar(DbDataReader reader)
        {
        ...
        private static void AddCatalogoParameters(DbCommand command, CatalogoPeca item)
        {
        ...
        private static int? ReadNullableInt(DbDataReader reader, int index)
        {
