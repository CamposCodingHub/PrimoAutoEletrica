...
namespace PrimoAutoEletrica.Models
{
    public class Orcamento
    {
        ...
        public string Status { get; set; } = "Rascunho"; // Rascunho, Enviado, Aprovado, Recusado, Vencido, Convertido em Venda, Convertido em OS
        ...
        public string DescontoTipo { get; set; } = "Valor";
