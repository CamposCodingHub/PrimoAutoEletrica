...
namespace PrimoAutoEletrica.Views.Clientes
{
    public partial class EditarClienteWindow : Window
    {
        ...
        private void CarregarDados()
        {
            ...
            SelecionarTipoPessoa(_cliente.TipoPessoa);
            ...
            SelecionarStatus(_cliente.Ativo);
        ...
        private Cliente MontarClienteDaTela()
        {
            ...
            _cliente.TipoPessoa = ObterTipoPessoaSelecionado();
            _cliente.CPF = CpfTextBox.Text.Trim();
            _cliente.RG = RgTextBox.Text.Trim();
            ...
            _cliente.Ativo = ObterStatusAtivoSelecionado();
        ...
        private void SelecionarTipoPessoa(string? tipoPessoa)
        {
            var tag = string.Equals(tipoPessoa, "Juridica", StringComparison.OrdinalIgnoreCase)
                ? "Juridica"
                : "Fisica";
            TipoPessoaComboBox.SelectedItem = TipoPessoaComboBox.Items
                .OfType<ComboBoxItem>()
        ...
        private void SelecionarStatus(bool ativo)
        {
            var tag = ativo ? "Ativo" : "Inativo";
            StatusClienteComboBox.SelectedItem = StatusClienteComboBox.Items
                .OfType<ComboBoxItem>()
                .FirstOrDefault(item => string.Equals(item.Tag?.ToString(), tag, StringComparison.OrdinalIgnoreCase));
        }
