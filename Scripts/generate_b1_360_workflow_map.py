...
def generate_360_workflow_map():
    content = """# PRIMOX WORKSHOP — MAPA DO FLUXO 360 (FASE B1)
...
"""
    with open("Docs/audit/2026-09-20/B1_360_WORKFLOW_MAP.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")
    print("B1_360_WORKFLOW_MAP.md written successfully.")

if __name__ == "__main__":
    generate_360_workflow_map()
