...
def generate_final_report():
    content = """# PRIMOX WORKSHOP — RELATÓRIO FINAL DE DISCOVERY (FASE B1)
...
"""
    with open("Docs/audit/2026-09-20/B1_PRODUCT_DISCOVERY_FINAL.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")
    print("B1_PRODUCT_DISCOVERY_FINAL.md written successfully.")
