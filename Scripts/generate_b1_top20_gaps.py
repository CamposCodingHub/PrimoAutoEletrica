...
def generate_top20_gaps():
    content = """# PRIMOX WORKSHOP — TOP 20 LACUNAS DO PRODUTO (FASE B1)
...
"""
    with open("Docs/audit/2026-09-20/B1_TOP20_PRODUCT_GAPS.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")
    print("B1_TOP20_PRODUCT_GAPS.md written successfully.")
