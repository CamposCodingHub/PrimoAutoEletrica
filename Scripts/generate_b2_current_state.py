...
def generate_b2_current_state():
    content = """# PRIMOX WORKSHOP — FASE B2
...
"""
    with open("Docs/audit/2026-09-20/B2_AUTOELETRICA_CURRENT_STATE.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")
    print("B2_AUTOELETRICA_CURRENT_STATE.md written successfully.")

if __name__ == "__main__":
    generate_b2_current_state()
