...
def generate_b2_routes_d01_d06():
    content = """# PRIMOX WORKSHOP — ROTEIROS TÉCNICOS DE DIAGNÓSTICO (D01 A D06)
...
"""
    with open("Docs/audit/2026-09-20/B2_DIAGNOSTIC_ROUTES_D01_D06.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")
    print("B2_DIAGNOSTIC_ROUTES_D01_D06.md written successfully.")

if __name__ == "__main__":
    generate_b2_routes_d01_d06()
