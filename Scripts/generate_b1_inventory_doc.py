...
def generate_inventory_md():
    content = """# PRIMOX WORKSHOP — INVENTÁRIO DO PRODUTO (FASE B1)
...
"""
    with open("Docs/audit/2026-09-20/B1_PRODUCT_INVENTORY.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")
    print("B1_PRODUCT_INVENTORY.md written successfully.")
