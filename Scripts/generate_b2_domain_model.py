...
def generate_b2_domain_model():
    content = """# PRIMOX WORKSHOP — MODELO DE DOMÍNIO DIAGNÓSTICO (FASE B2)
...
"""
    with open("Docs/audit/2026-09-20/B2_DIAGNOSTIC_DOMAIN_MODEL.md", "w", encoding="utf-8") as f:
        f.write(content.strip() + "\n")
    print("B2_DIAGNOSTIC_DOMAIN_MODEL.md written successfully.")

if __name__ == "__main__":
    generate_b2_domain_model()
